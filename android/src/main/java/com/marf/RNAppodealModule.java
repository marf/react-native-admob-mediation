...
public class RNAppodealModule extends ReactContextBaseJavaModule implements InterstitialCallbacks, BannerCallbacks, NonSkippableVideoCallbacks, RewardedVideoCallbacks, AppodealPermissionCallbacks {
	...
	@ReactMethod
	public void initialize(String appKey, int adTypes, Callback callback) {
	...
	public void getRewardParameters(ReadableMap args, Callback callback){
		...
		if (placement == null) {
			params.putInt("amount", Appodeal.getRewardParameters().first.intValue());
			params.putString("currency", Appodeal.getRewardParameters().second);
		} else {
			params.putInt("amount", Appodeal.getRewardParameters(placement).first.intValue());
	...
	public void onInterstitialShowFailed() {
		sendEventToJS("onInterstitialFailedShown", null);
	}
	...
	public void onBannerShowFailed() {
		sendEventToJS("onBannerFailedShown", null);
	}
	...
	public void onRewardedVideoShowFailed() {
		sendEventToJS("onRewardedVideoDidFailToPresentWithError", null);
	}
